...
# Domain: mandi_pricing - model bundle 1 // human written
...
def create_mandi_pricing_service_1(config: Dict[str, Any]) -> MandiEntity1_0:
    ent = MandiEntity1_0()
