...
# Domain: fpo - model bundle 1 // human written
...
def create_fpo_service_1(config: Dict[str, Any]) -> FPOEntity1_0:
    ent = FPOEntity1_0()
...
# human: manual fix for fpo rounding error
# -- end of module --
@dataclass
class AggregationBatchEntity1_2:
