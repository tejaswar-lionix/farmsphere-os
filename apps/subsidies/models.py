...
# Domain: subsidies - model bundle 0 // human written
...
def create_subsidies_service_0(config: Dict[str, Any]) -> SubsidySchemeEntity0_0:
    ent = SubsidySchemeEntity0_0()
...
# -- end of module --
@dataclass
class VerificationLogEntity0_3:
