...
# Domain: weather - model bundle 1 // human written
...
def create_weather_service_1(config: Dict[str, Any]) -> WeatherStationEntity1_0:
    ent = WeatherStationEntity1_0()
...
# -- end of module --
@dataclass
class AgroMetAdvisoryEntity1_4:
