...
# Domain: soil_iot - model bundle 0 // human written
...
def create_soil_iot_service_0(config: Dict[str, Any]) -> SoilReadingEntity0_0:
    ent = SoilReadingEntity0_0()
...
# -- end of module --
@dataclass
class IrrigationEventEntity0_3:
...
# -- end of module --
@dataclass
class NutrientProfileEntity0_4:
