...
# Domain: inventory - model bundle 1 // human written
...
def create_inventory_service_1(config: Dict[str, Any]) -> InventoryItemEntity1_0:
    ent = InventoryItemEntity1_0()
