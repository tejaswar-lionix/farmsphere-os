...
# Domain: mandi_pricing - model bundle 10 // human written
...
def create_mandi_pricing_service_10(config: Dict[str, Any]) -> MandiEntity10_0:
    ent = MandiEntity10_0()
