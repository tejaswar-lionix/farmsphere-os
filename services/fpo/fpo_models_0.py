...
# Domain: fpo - model bundle 10 // human written
...
def create_fpo_service_10(config: Dict[str, Any]) -> FPOEntity10_0:
    ent = FPOEntity10_0()
...
# -- end of module --
@dataclass
class AggregationBatchEntity10_2:
