...
# Domain: payments - model bundle 10 // human written
...
def create_payments_service_10(config: Dict[str, Any]) -> PaymentEntity10_0:
    ent = PaymentEntity10_0()
