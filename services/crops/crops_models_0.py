...
# Domain: crops - model bundle 10 // human written
...
def create_crops_service_10(config: Dict[str, Any]) -> CropEntity10_0:
    ent = CropEntity10_0()
...
# -- end of module --
@dataclass
class SowingScheduleEntity10_3:
