...
# Domain: weather - model bundle 10 // human written
...
@dataclass
class WeatherStationEntity10_0:
...
def create_weather_service_10(config: Dict[str, Any]) -> WeatherStationEntity10_0:
    ent = WeatherStationEntity10_0()
...
# -- end of module --
@dataclass
class AgroMetAdvisoryEntity10_4:
